...
describe('#reducer', () => {
  describe('when no action triggered', () => {
  ...
  describe('when action is SELECT_MOVIE', () => {
  ...
  describe('when action is DESELECT_MOVIE', () => {
  ...
  describe('when action is RECEIVE_GENRES', () => {
  ...
  describe('when action is REQUEST_MOVIES', () => {
  ...
  describe('when action is RECEIVE_MOVIES', () => {
